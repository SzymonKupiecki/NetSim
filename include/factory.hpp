...
public:
    ...
    [[nodiscard]] NodeCollection<Node>::const_iterator find_by_id(ElementID id) const{return std::find_if(nodes_.cbegin(), nodes_.end(), [id](Node& node){return node.get_id() == id;});}
...
public:
    ...
    [[nodiscard]] NodeCollection<Ramp>::const_iterator ramp_cbegin() {return ramps_.cbegin();}
    [[nodiscard]] NodeCollection<Ramp>::const_iterator ramp_cend() {return ramps_.cend();}
    // WORKERS
    ...
    [[nodiscard]] NodeCollection<Worker>::const_iterator worker_cbegin() {return workers_.cbegin();}
    [[nodiscard]] NodeCollection<Worker>::const_iterator worker_cend() {return workers_.cend();}
    // STOREHOUSES
    ...
    [[nodiscard]] NodeCollection<Storehouse>::const_iterator storehouse_cbegin() {return storehouses_.cbegin();}
    [[nodiscard]] NodeCollection<Storehouse>::const_iterator storehouse_cend() {return storehouses_.cend();}
    //REST
    bool is_consistent();
